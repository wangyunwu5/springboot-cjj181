$(document).ready(function() {
    ...
    $("#tab1 tbody tr").each(function(i) {
        ...
        $(this).find("td:eq(1) a").attr("href", "/cctv/pipe/makepipe?id=" + id);
        $(this).find("td:eq(4) input").click(function() {
            window.open("findinfoA?id=" + id);
        });
        $(this).find("td:eq(5) input").click(function() {
            window.open("findinfoB?id=" + id);
        });
        $(this).find("td:eq(6) input").click(function() {
            window.open("findinfoC?id=" + id);
        });
        /*********************************************/
